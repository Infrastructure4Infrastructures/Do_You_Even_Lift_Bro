    ...
    <div className="programs">
      <h2>Select a Workout Difficulty</h2>
        <li>
            ...
            <button type="button" onclick="/workouts/beginner">Select Workout</button>
        </li>

        <li>
            <h3>Intermediate Workout</h3>
            <button type="button" onclick="/workout/intermediate">Select Workout</button>
        </li>

        <li>
            <h3>Advanced Workout</h3>
            <button type="button" onclick="/workout/advanced">Select Workout</button>
        </li>
